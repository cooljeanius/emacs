...
# Generated by GNU Autoconf 2.69 for emacs 24.3.50.
#
#
...
if ${gl_cv_warn_c__Wno_format_extra_args+:} false; then :
  $as_echo_n "(cached) " >&6
else
...
if test "x$gl_cv_warn_c__Wno_format_extra_args" = xyes; then :
...
if test "x$gl_cv_warn_c__Wno_unused_value" = xyes; then :
...
$as_echo "#define CANNOT_DUMP 1" >>confdefs.h
  ...
  { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Addresses are sanitized; suggest CANNOT_DUMP=yes" >&5
$as_echo "$as_me: WARNING: Addresses are sanitized; suggest CANNOT_DUMP=yes" >&2;}
fi
...
if ${gl_cv_warn_c__Wno_unused_variable+:} false; then :
  $as_echo_n "(cached) " >&6
else
...
if test "x$gl_cv_warn_c__Wno_unused_variable" = xyes; then :
...
if ${gl_cv_warn_c__Wno_unused_but_set_variable+:} false; then :
  $as_echo_n "(cached) " >&6
else
...
if test "x$gl_cv_warn_c__Wno_unused_but_set_variable" = xyes; then :
...
if ${gl_cv_warn_c__Wno_unused_but_set_parameter+:} false; then :
  $as_echo_n "(cached) " >&6
else
...
if test "x$gl_cv_warn_c__Wno_unused_but_set_parameter" = xyes; then :
...
#include <gtk/gtk.h>
"
if test "x$ac_cv_have_decl_GTK_TYPE_HANDLE_BOX" = xyes; then :
...
if test "x$ac_cv_func_gtk_handle_box_new" = xyes; then :
  cat >>confdefs.h <<_ACEOF
...
#include <gtk/gtk.h>
"
if test "x$ac_cv_have_decl_GTK_TYPE_TEAROFF_MENU_ITEM" = xyes; then :
...
if test "x$ac_cv_func_gtk_tearoff_menu_item_new" = xyes; then :
  cat >>confdefs.h <<_ACEOF
  ...
  cygwin )
    ...
    $as_echo "#define PTY_ITERATION int i; for (i = 0; i < 1; i++)" >>confdefs.h
        ...
        $as_echo "#define FIRST_PTY_LETTER 'p'" >>confdefs.h
                ...
                $as_echo "#define PTY_OPEN  do { int slave; if (openpty (&fd, &slave, pty_name, NULL, NULL) == -1) fd = -1; else emacs_close (slave); } while (false)" >>confdefs.h
