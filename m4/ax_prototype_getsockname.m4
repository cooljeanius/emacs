# ax_prototype_getsockname.m4                              -*- Autoconf -*-
#==========================================================================
...
AN_FUNCTION([getsockname],[AX_PROTOTYPE_GETSOCKNAME])dnl
AU_ALIAS([AC_PROTOTYPE_GETSOCKNAME],[AX_PROTOTYPE_GETSOCKNAME])dnl
